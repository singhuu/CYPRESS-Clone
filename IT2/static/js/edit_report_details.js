...
function initialize() {
    var temp = arr;
    var lat = temp[0].substring(1, temp[0].indexOf(","));
    var lng = temp[0].substring(temp[0].indexOf(",") + 2, temp[0].length - 1);
    ...
    var contentString = "<h4>" + arr[1] + "</h4>" + arr[2];
    var infowindow = new google.maps.InfoWindow({
    ...
    google.maps.event.addListener(marker, 'click', (function(marker, j) {
        return function() {
            ...
            infowindow.setContent("<h4>" + arr[1] + "</h4>" + arr[2]);
